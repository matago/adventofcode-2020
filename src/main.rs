mod days;
use days::{day01, day02, day03, day04, day05, day06, day07, day08, day09, utils::Part};
...
async fn runner(day: &Days) -> () {
    match &day {
        ...
        Days::Day09 => {
            println!("Day 9.1: {}", day09::run(Part::One).await.unwrap());
            println!("Day 9.2: {}", day09::run(Part::Two).await.unwrap())
        }
    }
}
#[tokio::main]
